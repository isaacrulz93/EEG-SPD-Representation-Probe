...
python -m pytest -q tests/test_baseline_trajectory_data_v0.py tests/test_baseline_trajectory_geometry_v0.py tests/test_baseline_trajectory_protocol_v0.py tests/test_baseline_trajectory_action_v0.py
...
python scripts/60_action_null_v0.py
...
PY
python scripts/60_finalize_v0.py
python -m pytest -q tests/test_baseline_trajectory_data_v0.py tests/test_baseline_trajectory_geometry_v0.py tests/test_baseline_trajectory_protocol_v0.py tests/test_baseline_trajectory_action_v0.py
git diff --check
